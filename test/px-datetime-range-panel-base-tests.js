...
function runBaseTests() {
  px_datetime_range_panel_1 = document.getElementById('px_datetime_range_panel_1');

  suite('Base Automation Tests for px-datetime-range-panel', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-datetime-range-panel fixture is created', function() {
      assert.isTrue(document.getElementById('px_datetime_range_panel_1') !== null);
    });
